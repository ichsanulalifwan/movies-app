...
class MoviePopularAdapter : PagedListAdapter<MoviePopularEntity, MoviePopularAdapter.MovieViewHolder>(DIFF_CALLBACK)  {
    ...
    inner class MovieViewHolder(private val binding: ItemListBinding) :
        ...
        fun bind(movies: MoviePopularEntity) {
            with(binding) {
    ...
    interface OnItemClickListener {
        fun onMoviesClicked(movies: MoviePopularEntity)
    }

    companion object {
        private val DIFF_CALLBACK = object : DiffUtil.ItemCallback<MoviePopularEntity>() {
